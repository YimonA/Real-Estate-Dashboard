                  ...
                  <div className="w-full lg:basis-6/12 px-5  pt-5 py-10 bg-white">
                    ...
                    <ul className=" text-gray-500 lg:flex flex-col gap-2">
                      <li className=" flex justify-between items-center pb-2">
                        ...
                        <span>
                          {rentDetailData?.roomDimensions?.livingRoom === null
                            ? "9x10"
                            : rentDetailData?.roomDimensions?.livingRoom}
                        </span>
                      </li>
                      <li className=" flex justify-between items-center pb-2">
                        <span>Bedroom</span>
                        <span>
                          {rentDetailData?.roomDimensions?.bedRoom === null
                            ? "12x10"
                            : rentDetailData?.roomDimensions?.bedRoom}
                        </span>
                      </li>
                      <li className=" flex justify-between items-center pb-2">
                        <span>Dining Room</span>
                        <span>
                          {rentDetailData?.roomDimensions?.diningRoom === null
                            ? "15x10"
                            : rentDetailData?.roomDimensions?.diningRoom}
                        </span>
                      </li>
                      <li className=" flex justify-between items-center pb-2">
                        <span>Kitchen</span>
                        <span>
                          {rentDetailData?.roomDimensions?.kitchen === null
                            ? "9x7"
                            : rentDetailData?.roomDimensions?.kitchen}
                        </span>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="w-full lg:basis-6/12 px-5  pt-5 py-10 bg-white">
                  ...
                  <ul className=" text-gray-500">
                    ...
                    <li className=" flex justify-between items-center pb-2">
                      <span>Bedrooms</span>
                      <span>
                        {rentDetailData?.bedrooms === null
                          ? "1"
                          : rentDetailData?.bedrooms}
                      </span>
                    </li>
                    <li className=" flex justify-between items-center pb-2">
                      <span>Bathrooms</span>
                      <span>
                        {rentDetailData?.bathrooms === null
                          ? "1"
                          : rentDetailData?.bathrooms}
                      </span>
                    </li>
                    <li className=" flex justify-between items-center pb-2">
                ...
                <div className="w-full lg:basis-6/12 px-5  pt-5 py-10 bg-white mt-5">
                  ...
                  <ul className=" text-gray-500">
                    ...
                    <li className=" flex justify-between items-center pb-2">
                      ...
                      <span>
                        {rentDetailData?.createdDate.substring(0, 10)}
                      </span>
                    </li>
                    <li className=" flex justify-between items-center pb-2">
